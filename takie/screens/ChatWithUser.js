...
const ChatWithUser = () => {
  ...
  const handleSend = async () => {
    try {
     ...
     const response=await axios.post("http://192.168.14.201:4200/sendMessage",handleData)
  ...
  const getChat = async () => {
    try {
      const response = await axios.get(`http://192.168.14.201:4200/message/${userId}/${recepientId}`);
